  ...
  return (
    <section className="relative bg-az-black py-24 lg:py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[700px] mx-auto px-4 sm:px-6 text-center">
        ...
        <motion.div initial={{ opacity: 0, y: 20, scale: 0.95 }} whileInView={{ opacity: 1, y: 0, scale: 1 }} viewport={{ once: true, amount: 0.3 }} transition={{ delay: 0.3, duration: 0.5, ease: [0.175, 0.885, 0.32, 1.275] as [number, number, number, number] }}>
