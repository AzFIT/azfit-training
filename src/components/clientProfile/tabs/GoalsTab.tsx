      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {activeGoals.map((goal, i) => (
          <motion.div
            ...
            className="bg-[#141414] border border-dark-border rounded-xl p-5 hover:-translate-y-0.5 hover:shadow-[0_4px_20px_rgba(0,174,239,0.1)] transition-all duration-200"
          >
            ...
            <table className="w-full">
              ...
              <tbody>
                {completedGoals.map((g) => (
                  <tr key={g.id} className="border-b border-dark-divider hover:bg-[#1A1A1A] transition-colors">
