            ...
            {muscleDistribution.length === 0 ? (
              ...
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  ...
                  <Legend wrapperStyle={{ fontSize: 11, color: 'dark-secondary' }} />
                </PieChart>
              </ResponsiveContainer>
            )}
          </div>
            ...
            {filtered.length === 0 ? (
              ...
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={filtered.slice(0, 6)} layout="vertical">
                  ...
                  <YAxis dataKey="name" type="category" tick={{ fill: 'dark-secondary', fontSize: 10 }} width={100} />
                  <Tooltip contentStyle={{ background: 'az-black-card', border: '1px solid dark-border', borderRadius: 8, color: 'dark-primary' }} />
                  <Bar dataKey="timesDone" fill="cyan" radius={[0, 4, 4, 0]} />
                </BarChart>
              </ResponsiveContainer>
            )}
          </div>
