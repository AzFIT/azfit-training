...
export function KpiCard({ label, value, unit, change, icon: Icon, inverse }: {
  ...
  return (
    <motion.div
      ...
      className="bg-gradient-to-br from-[rgba(0,174,239,0.08)] to-[rgba(139,92,246,0.04)] bg-[#141414] border border-dark-border rounded-xl p-5 hover:-translate-y-0.5 hover:shadow-[0_4px_20px_rgba(0,174,239,0.1)] transition-all duration-200"
    >
