    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h1 className="text-dark-primary text-xl font-semibold truncate">
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2 px-4 py-3 rounded-lg bg-[#141414] border border-dark-border/30">
        ...
        {program.training_split && (
          <div className="flex items-center gap-1.5 text-xs text-dark-secondary">
            <BarChart3 size={12} className="text-dark-muted" />
            <span className="text-dark-primary font-medium">{program.training_split}</span>
          </div>
        )}
        {program.periodization_phase && (
          <div className="text-xs text-dark-secondary">
            <span className="text-[11px] px-2 py-0.5 rounded font-medium bg-violet/10 text-violet border border-violet/30">
              {program.periodization_phase}
            </span>
          </div>
        )}
