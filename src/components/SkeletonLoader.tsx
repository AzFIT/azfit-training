...
export default function SkeletonLoader({ variant, count = 1, className }: SkeletonLoaderProps) {
  const renderSkeleton = () => {
    switch (variant) {
      case 'card':
        return (
          <div className={cn('bg-white dark:bg-[#141414] rounded-2xl p-6 border border-gray-200 dark:border-white/5', className)}>
      ...
      case 'list':
        return (
          <div className={cn('space-y-3', className)}>
            {[...Array(4)].map((_, i) => (
              <div key={i} className="flex items-center gap-4 p-4 bg-white dark:bg-[#141414] rounded-xl border border-gray-200 dark:border-white/5">
      ...
      case 'table':
        return (
          <div className={cn('bg-white dark:bg-[#141414] rounded-2xl border border-gray-200 dark:border-white/5 overflow-hidden', className)}>
