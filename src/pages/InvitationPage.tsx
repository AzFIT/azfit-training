              ...
              <div className="flex flex-col items-center">
                <div
                  className={`w-3 h-3 rounded-full transition-colors ${
                    step > i + 1 ? 'bg-success' : step === i + 1 ? 'bg-[#A855F7]' : 'bg-gray-300'
                  }`}
                />
                <span className={`text-[10px] mt-1 font-medium ${step === i + 1 ? 'text-[#A855F7]' : 'text-gray-400'}`}>
                  {label}
                </span>
              </div>
        ...
        <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="bg-gray-50 rounded-xl p-5 space-y-3 mb-6">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="inline-block px-2 py-0.5 bg-[rgba(168,85,247,0.1)] text-[#A855F7] text-caption font-semibold rounded-full">
                    Administrator
                  </span>
                </div>
                <div className="flex justify-between">
              ...
              <label className="flex items-start gap-3 cursor-pointer mb-4">
                <input
                  ...
                  className="w-5 h-5 mt-0.5 rounded border-gray-300 text-[#A855F7] focus:ring-[#A855F7]"
                />
                <span className="text-body-sm text-gray-600">
                  I agree to the{' '}
                  <span className="text-[#A855F7] cursor-pointer">Terms of Service</span> and{' '}
              ...
              <form onSubmit={handleComplete} className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-gray-50 border-[1.5px] border-gray-200 rounded-xl text-sm focus:border-[#A855F7] outline-none"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-10 py-3 bg-gray-50 border-[1.5px] border-gray-200 rounded-xl text-sm focus:border-[#A855F7] outline-none"
                    />
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-10 py-3 bg-gray-50 border-[1.5px] rounded-xl text-sm outline-none ${
                        confirmPassword && password !== confirmPassword ? 'border-danger' : 'border-gray-200 focus:border-[#A855F7]'
                      }`}
                    />
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                  ...
                  <button
                    ...
                    className={`w-12 h-7 rounded-full transition-colors relative ${enableMfa ? 'bg-[#A855F7]' : 'bg-gray-300'}`}
                  >
          ...
          {step === 3 && (
            ...
            >
              ...
              >
                <CheckCircle size={56} className="text-[#A855F7] mx-auto mb-4" />
              </motion.div>
