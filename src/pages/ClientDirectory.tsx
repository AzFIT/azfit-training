    ...
    >
      {stats.map((stat) => (
        <motion.div
          key={stat.label}
          variants={cardFadeUp}
          className="flex items-center gap-3 px-4 py-3 bg-white dark:bg-[#141414] rounded-xl border border-gray-200 dark:border-white/[0.06] shadow-card"
        >
          ...
          <div>
            ...
            <p className="text-data-md font-mono font-bold text-gray-900 dark:text-white">{stat.value}</p>
          </div>
        </motion.div>
      ))}
    </motion.div>
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-[1440px] mx-auto">
      ...
      <motion.div
        ...
        className="mb-6"
      >
        <h1 className="text-display-md font-semibold text-gray-900 dark:text-white">Clients</h1>
      ...
      >
        ...
        <div className="relative flex-1 min-w-[240px] max-w-[400px]">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2.5 text-sm bg-white dark:bg-[#141414] border border-gray-200 dark:border-white/10 rounded-xl outline-none focus:border-cyan text-gray-900 dark:text-white placeholder:text-gray-400"
          />
        </div>
        ...
        <select
          ...
          className="text-sm bg-white dark:bg-[#141414] border border-gray-200 dark:border-white/10 rounded-xl px-3 py-2.5 text-gray-700 dark:text-gray-300 outline-none focus:border-cyan"
        >
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium border border-gray-200 dark:border-white/10 rounded-xl hover:bg-gray-50 dark:hover:bg-white/5 text-gray-700 dark:text-gray-300 transition-colors"
        >
      ...
      >
        <div className="overflow-x-auto">
          <table className="w-full min-w-[800px]">
            {/* Header */}
            <thead>
              <tr className="bg-gray-50 dark:bg-[#1A1A1A] border-b border-gray-200 dark:border-white/[0.06]">
                {[
                  ...
                  <th
                    ...
                    className={`text-left text-caption font-semibold text-gray-500 uppercase tracking-wider px-5 py-3.5 ${
                      col.key ? 'cursor-pointer select-none group hover:text-gray-700 dark:hover:text-gray-300' : ''
                    }`}
                ...
                <tr>
                  <td colSpan={6}>
                    <div className="flex flex-col items-center justify-center py-14 text-center">
                      ...
                      <p className="text-heading-sm text-gray-700 dark:text-gray-300 mb-1">No clients found</p>
                ...
                paginated.map((client, idx) => {
                  ...
                  return (
                    <motion.tr
                      ...
                      className="border-b border-gray-100 dark:border-white/[0.04] hover:bg-gray-50 dark:hover:bg-[#1A1A1A] cursor-pointer transition-colors duration-150"
                    >
                      {/* Client */}
                        ...
                        <div className="flex items-center gap-3">
                          <div className="flex-1 h-1.5 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                            <motion.div
                              ...
                              transition={{ duration: 0.8, ease: [0.25, 0.1, 0.25, 1] as [number, number, number, number], delay: idx * 0.03 }}
                      ...
                      <td className="px-5 py-3.5">
                        <div className="flex items-center gap-1" onClick={(e) => e.stopPropagation()}>
                          <button
                            onClick={() => handleRowClick(client.id)}
                            className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-white/10 text-gray-400 hover:text-cyan transition-colors"
                            title="View profile"
                          >
                            <Eye size={16} />
                          </button>
                          <button
                            ...
                            className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-white/10 text-gray-400 hover:text-warning transition-colors"
                            title="Quick edit"
                          >
                            <Pencil size={16} />
                          </button>
                          <button
                            ...
                            className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-white/10 text-gray-400 hover:text-info transition-colors"
                            title="Send message"
                          >
        ...
        {/* Pagination */}
        {filtered.length > 0 && (
          <div className="flex flex-wrap items-center justify-between gap-4 px-5 py-4 border-t border-gray-100 dark:border-white/[0.04]">
            <div className="flex items-center gap-3">
              ...
              <select
                ...
                className="text-caption bg-gray-50 dark:bg-[#1A1A1A] border border-gray-200 dark:border-white/10 rounded-lg px-2 py-1 text-gray-700 dark:text-gray-300 outline-none"
              >
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                disabled={safePage === 1}
                className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-white/10 text-gray-500 disabled:opacity-40 transition-colors"
              >
                <ChevronLeft size={16} />
              </button>
