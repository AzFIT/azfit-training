    ...
    <div className="max-w-[600px] mx-auto">
      ...
      <div className="bg-az-black-card border border-dark-border rounded-xl p-5 mb-6">
        ...
        <textarea
          ...
          rows={3}
          className="w-full bg-az-black-elevated border border-dark-border focus:border-cyan text-dark-primary text-sm placeholder:text-dark-muted px-4 py-2.5 rounded-xl outline-none resize-none transition-colors"
        />
      </div>
