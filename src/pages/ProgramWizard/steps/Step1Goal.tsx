        ...
        {GOAL_CARDS.map((goal, i) => {
          ...
          return (
            ...
            >
              ...
              >
                <Icon size={28} style={{ color: goal.gradient.includes('8B5CF6') ? 'violet' : goal.gradient.includes('F97316') ? 'orange' : goal.gradient.includes('00AEEF') ? 'cyan' : goal.gradient.includes('22C55E') ? 'success' : goal.gradient.includes('EAB308') ? 'warning' : 'silver' }} />
              </div>
