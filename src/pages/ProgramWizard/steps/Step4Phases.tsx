...
export default function Step4Phases({ phases, onChange }: Step4PhasesProps) {
  ...
  const colors = ['cyan', 'violet', 'success', 'orange', 'trainer-accent', 'warning']
            ...
            >
              ...
              <div className="flex items-center gap-2 mt-4 pt-3 border-t border-dark-divider">
                ...
                <button
                  ...
                  className="text-danger hover:text-[danger] text-xs flex items-center gap-1 px-2 py-1 rounded hover:bg-[rgba(239,68,68,0.1)] transition-colors disabled:opacity-30"
                >
