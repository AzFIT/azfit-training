        ...
        {hasClient && (
          <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} className="overflow-hidden">
            <input
              ...
              className="w-full bg-[#1A1A1A] border border-dark-border focus:border-cyan text-dark-primary text-sm px-4 py-2.5 rounded-xl outline-none transition-colors"
            />
          </motion.div>
        )}
      </div>
          ...
          <button
            ...
            className={cn(
              ...
              context.experience === exp
                ...
                : 'border-dark-border bg-[#141414] text-dark-secondary hover:border-dark-subtle'
            )}
          >
            {exp}
          </button>
            ...
            <button
              ...
              className={cn(
                ...
                context.availableDays.includes(day)
                  ...
                  : 'border-dark-border bg-[#141414] text-dark-muted hover:border-dark-subtle'
              )}
            >
              {day.slice(0, 3)}
            </button>
